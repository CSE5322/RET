...
public class CreateBusinessProcessDialog extends JDialog {
	 ...
	 * public static void main(String[] args) {
		try {
			CreateBusinessProcessDialog dialog = new CreateBusinessProcessDialog();
...
*/
	 ...
	 * Create the dialog.
	 */
	public CreateBusinessProcessDialog(TestSwing parent,Phrase phrase) {
		...
		{
			{
				...
				//	txtVerb.setOpaque(false);
					...
					getContentPane().add(lblNewLabel);
						...
						createButton.setBounds(164, 201, 93, 22);
				...
				//	this.setvi
					...
					createButton.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent arg) {
							...
							parent.refreshTree();
							//((TestSwing)((CreateBusinessProcessDialog)getParent()).getParent()).refreshTree();
